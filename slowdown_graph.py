...
def get_experiment(protocol):
    if protocol == "SharedReg":
        file_prefix = "sharedresults_results/slowed_node_50/throughput_" 
    else:
        file_prefix = "etcd_results/slowed_leader_50/throughput_" 
    all_throughput = []
...
# plt.show()
plt.savefig('slowed_nodes.pdf')
plt.savefig("slowed_nodes.png")